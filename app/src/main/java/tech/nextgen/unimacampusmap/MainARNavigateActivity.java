...
public class MainARNavigateActivity extends AppCompatActivity {

  private static final String TAG = MainARNavigateActivity.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_main_ar_navigate);

    //bottom navigation bar
    bottomNavigationView = findViewById(R.id.bottom_navigator);
    bottomNavigationView.setSelectedItemId(R.id.arNavMenu);
        ...
        mMapView.setOnTouchListener(new DefaultMapViewOnTouchListener(this, mMapView) {
          ...
          public boolean onSingleTapConfirmed(MotionEvent motionEvent) {
            ...
            if (mStartPoint == null) {
              ...
              mStartPoint = MainARNavigateActivity.this.mMapView.screenToLocation(
              ...
              mEndPoint = MainARNavigateActivity.this.mMapView.screenToLocation(
                  new android.graphics.Point(Math.round(motionEvent.getX()), Math.round(motionEvent.getY())));
                  ...
                  routeResultFuture.addDoneListener(() -> {
                    try {
                      ...
                      mNavigateButton.setOnClickListener(v -> {
                        ...
                        Intent intent = new Intent(MainARNavigateActivity.this, ARNavigateActivity.class);
                      ...
                      Toast.makeText(MainARNavigateActivity.this, error, Toast.LENGTH_LONG).show();
                      Log.e(TAG, error);
                    }
                  });
